...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EpQA9PSbJYayYGNwxZP8.26EM2o+nBqPn+GPYKpfBAa.pjLQQ/39hxUZEKBGO97aOllL0Qy9DrmaFzrhDu/D6h4=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EpErx18Aoj4tGishoet1.C+TdLVVLQdydLYvK6wIuiq.VNd8jLfCYxIj9lnnKMoxptH/pbnBFwEPb2pnibdOfs8=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EpbCzGtRlwyb2qx0mOWe.PxAXNlSCMIA2nMcrtUErVG.vpIGcIqmXtBIGs+ehkDP+l4g7YihM2Hfzs0nqoVGNpE=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Ep3TBQP899CUq4qXrba8.2k5RU+pBtUFei2dSstwBEa.pLqN5e0SRTxcGxW8TbjG4Tk8a2aWga55eGxJEIMGJSA=")
kc.loginResult()

kg = LINETCR.LINE()
kg.login(token="Epm4vlhku2VCuXQbEqRc.3nkuNiO4VRwNsW011Xda7a.eWaBdRyIu8oL20tDbJdbbHsU9VRlUCunmZGKjT/zDiA=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EpCcughdxta86ij0BD84.wYJrjn8mz5Ran8sdCRC21a.MkI7x4Q+hoNy2ite3NAxTeFFyz43dDDoYycx9sZN384=")
kh.loginResult()

ka = LINETCR.LINE()
#kt.login(qr=True)
ka.login(token="Ep1Bj85WLm79jSg0Umq4.qkVMwfaC5ZnQ1ys7F5mN1a.smbdMWq8im91gKNbsBwzprvOupvIercHlyPBLZJIkjo=")
ka.loginResult()

kb = LINETCR.LINE()
#k2.login(qr=True)
kb.login(token="Ep5jib7G233sq1zZPkT2.0gpQnDl8iUc3Y3E5HKAm0G.ClzVsaWq2waqRPp3J2wWw8hTPd9wwjSGwYlDytXR0LU=")
kb.loginResult()
...
╚══════════════════╝️
"""
KAC=[cl,ki,kk,kc,kg,kh,ka,kb]
DEF=[ki,kk,kc,kg,kh,ka,kb]
